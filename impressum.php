...
<head>
    <meta charset="UTF-8">
    <title>Impressum - Zum Roten Tuch</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h4>Monika Nowak</h4>
                        <a href="tel:+436769301458">+43 676 930 1458</a><br>
                        <a href="mailto:monika.nowak@modes.at">monika.nowak@modes.at</a>
                        <p>Gewerbepark 24<br>6068 Mils<br>Österreich</p>
                        <p><strong>Unternehmensgegenstand:</strong> Schneiderei</p>
                        <p><strong>UID-Nummer:</strong> ATU38694301</p>
                        <p><strong>Mitgleid bei:</strong> WK Tirol</p>
                        <p><strong>Berufsrecht:</strong> Gewerbeordnung <a href="https://www.ris.bka.gv.at/">www.ris.bka.gv.at</a></p>
                        <p><strong>Aufsichtsbehörde/Gewerbebehörde:</strong> Bezirkshauptmannschaft Innsbruck</p>
                        <p><strong>Berufsbezeichnung:</strong> Änderungsschneiderei und Handel mit Bekleidung und Textilien</p>
                        <p><strong>Verleihungsstaat:</strong> Österreich</p>
                        <p>Angaben zur Online-Streitbelegung: Verbraucher haben die Möglichkeit, Beschwerden an die Online-Streitbeilegungsplattform der EU zu richten: <a href="http://ec.europa.eu/odr">http://ec.europa.eu/odr</a>. Sie können allfällige Beschwerde auch an die oben angegebene E-Mail-Adresse richten.</p>
